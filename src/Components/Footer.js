...
function Footer() {
  ...
  return (
    <div className="flex flex-row items-center p-1 bg-opacity-50 bg-black z-50 absolute w-full justify-between px-2">
      <a href="https://github.com/soumyajit4419/Portfolio" target="_blank" rel="noreferrer" className="text-white font-large items-center hidden md:flex">Inspiration from Soumyajit &nbsp;<BiLinkExternal/></a>
