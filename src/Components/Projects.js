    ...
    return (
        <>
            ...
            <div className="flex flex-wrap md:px-5">
                <ProjectCard Title={"DigiBooking"} Tags={"Webdev IOT"} Description={"Event booking website, Using face data to book images, Your Face will be your Tickets! Made using AWS Rekognition."} Link={"https://github.com/viralgupta?tab=repositories&q=digi-booking"} Imagelink={"Assets/Projects/digibooking.png"} />
